      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
          <div className="flex items-center gap-2 mb-2">
            <span className="px-3 py-1 rounded-full text-xs font-semibold bg-cyan-400/10 text-[#22D3EE] border border-cyan-400/30">
      ...
      <div className="labx-card p-4 mb-8 flex flex-col md:flex-row gap-4 justify-between items-center">
        ...
        <div className="flex flex-wrap gap-3 w-full md:w-auto">
          ...
          <select
            ...
            className="px-3.5 py-2 rounded-xl bg-labx-surface border border-labx-border text-xs text-labx-text focus:outline-none focus:border-cyan-300"
          >
