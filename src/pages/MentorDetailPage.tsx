...
export default function MentorDetailPage() {
  ...
  return (
    ...
    >
      <Link to="/mentors" className="inline-flex items-center gap-2 text-xs font-semibold text-labx-text-muted hover:text-labx-cyan mb-6 transition-colors">
          ...
          <div className="labx-card p-6 sm:p-8">
            ...
            <div className="flex flex-wrap gap-2 mb-6">
              {mentor.expertise.map(exp => (
                <span key={exp} className="px-3 py-1 rounded-lg text-xs font-mono bg-labx-cyan/10 text-labx-cyan border border-labx-cyan/20 font-medium">
                  {exp}
                </span>
              ))}
          ...
          <div className="labx-card p-6 relative overflow-hidden">
            ...
            {isBooked ? (
              <div className="text-center py-8 space-y-3">
                ...
                <button onClick={() => setIsBooked(false)} className="text-xs font-semibold text-labx-cyan underline pt-2">
              ...
              <form onSubmit={handleBooking} className="space-y-4">
                <div>
                  ...
                  <select
                    ...
                    required
                    className="w-full px-3 py-2 rounded-xl bg-labx-surface border border-labx-border text-xs text-labx-text focus:outline-none focus:border-labx-cyan/50"
                  >
